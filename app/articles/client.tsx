    ...
    <>
      ...
      <div style={{ visibility: isRestoringScroll ? "hidden" : "visible" }}>
        <div className="px-4 lg:px-8 py-8">
          ...
          <button
            onClick={scrollToTop}
            className={`fixed bottom-6 right-6 w-12 h-12 cursor-pointer bg-emerald text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 z-50 hover:bg-emerald/90 ${
